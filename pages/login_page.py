...
class SportyLoginPage(SportyNavBarPage):
    ...
    MOBILE_NUMBER:Tuple[By, str]=(By.XPATH,"//input[@placeholder='Mobile Number']")
    START_EXPLORING:Tuple[By, str]=(By.XPATH,"//button[span='Start Exploring']")
    PASSWORD:Tuple[By, str]=(By.XPATH,"//input[@placeholder='Password']")
    LOGIN_BUTTON:Tuple[By, str]=(By.XPATH,"//button[span='Log In']")
    COUNTRY_CODE_COMBOBOX:Tuple[By,str]=(By.XPATH,"//div[contains(@class, 'phone-input')]//i")
    COUNTRY_CODE:Tuple[By,str]=(By.XPATH,"//div[contains(@class, 'phone-input')]//div[contains(@class, 'phone')]")
    COUNTRY_FLAG:Tuple[By,str]=(By.XPATH,"//div[contains(@class, 'phone-input')]//img[contains(@class, 'flag')]")
