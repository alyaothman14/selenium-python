...
class TestLogin(BaseTest):
        ...
        def test_invalid_phone_number(self):
              ...
              error_message= self.driver.find_element(By.XPATH,"//*[contains(text(),'Incorrect username or password')]")
        ...
        def test_invalid_input_number(self):
              ...
              assert (self.driver.find_element(*self.login_page.MOBILE_NUMBER).get_attribute("value"))==""
              assert (self.driver.find_element(*self.login_page.START_EXPLORING).get_attribute("disabled"))
        ...
        def test_country_code_change(self,country_code_data):
               ...
               self.driver.execute_script('return console.log("Hello from the console log")')
